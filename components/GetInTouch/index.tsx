...
const GetInTouch = () => {
  return (
    <div className="bg-pink-50 py-12 px-4 text-center">
      ...
      <p className="mt-5 mx-auto text-customgray text-center font-[400] font-poppins text-[16px] leading-[26px] max-w-xs md:max-w-md ">
      ...
      <div className="mt-5 flex flex-col justify-center gap-4 sm:flex-row">
        <button className="rounded-full bg-gradient-to-r from-pink-500 to-red-500 px-6 py-3 font-semibold text-white shadow-lg font-poppins border-2">
          Contact Us
        </button>
      </div>
    </div>
